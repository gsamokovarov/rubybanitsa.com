...
module Fortune
  ...
  mattr_accessor :fortunes, default: [
    "Таз година ще сполучиш, Strategy Pattern ще научиш.",
    "Три пъти го провери, теста да не изгърми.",
    "Молбата приготви, продукцията ще гърми!",
    "Късмет, любов... КАРТОФ!",
    ...
    "На рубини ти върви - голяма любов ще те сполети.",
    ...
    "За голямо учене се приготви - React ще чоплиш ти.",
