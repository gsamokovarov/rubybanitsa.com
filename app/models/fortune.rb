...
module Fortune
  ...
  mattr_accessor :fortunes, default: [
    ...
    "Бизнеса ще ти върви, милиони в сървъри ще даваш ти! 💰",
    "Велосипедиста пощади, в бордюра се блъсни! 💥",
    "На рубини ти върви - голяма любов ще те сполети. ❤️",
    "Тестовете си пиши, някой билд да не те изплющи! 🙅‍♂️",
    "Много ще те мързи, цяла година рубокоп ще чистиш ти... 👾",
    "Хич не му мисли, нова работа си намери - а най-добре в Ар Би! 🏢",
    ...
    "На работа не идвай ти, на колелото се качи! 🚲",
